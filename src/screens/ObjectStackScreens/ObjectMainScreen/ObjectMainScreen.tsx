...
const data = [
  {
    ...
    subtitle: 'ЖК “Астра” | Пермь, ул. Ленина 78',
  },
  {
    id: '2',
...
const ObjectMainScreen: React.FC = () => {
    ...
    <>
      <SafeAreaView style={styles.containerMain} edges={["top", "bottom"]}>
        <SafeAreaView edges={["left", "right"]}>
          <Header onPressLeft={() => setViewPopup(true)} title="Объекты"/>
        </SafeAreaView>
        ...
        <ScrollView contentContainerStyle={styles.containerScroll}>
          <SafeAreaView edges={["left", "right"]} style={styles.container}>
            ...
            <View style={styles.actions}>
              ...
              <Pressable onPress={() => navigation.navigate('ObjectStack', { screen: 'ObjectChooseObject' })} style={styles.pressable}>
...
export default ObjectMainScreen;
