      ...
      <Animated.View style={[styles.container, { backgroundColor }]}>
        <View style={styles.wrapper}>
          <View style={styles.containerLeft}>
            <Animated.Text numberOfLines={1} ellipsizeMode="tail"  style={[styles.text, { color }]}>{title}</Animated.Text>
            <Animated.Text numberOfLines={1} ellipsizeMode="tail" style={[styles.text, { color }]}>{subtitle}</Animated.Text>
          </View>
